...
export function Contact() {
  const socialLinks = [
    {
      name: 'Email',
      url: 'mailto:moulishwaran2002@gmail.com',
      icon: (
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/MurthyMoulishwaran',
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/m-moulishwaran-321841248/',
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="max-w-2xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {socialLinks.map((link) => (
                <a
                  ...
                  className="flex flex-col items-center p-4 bg-gray-800/50 rounded-lg hover:bg-gray-700/50 transition-colors border border-gray-700"
                >
                  <div className="text-purple-400 mb-2">{link.icon}</div>
            ...
            <div className="mt-8 text-center">
              <p className="text-gray-300">
                ...
                <a
                  href="mailto:moulishwaran2002@gmail.com"
                  className="text-purple-400 hover:text-purple-300 transition-colors"
                >
                  moulishwaran2002@gmail.com
                </a>
              </p>
            </div>
          </div>
